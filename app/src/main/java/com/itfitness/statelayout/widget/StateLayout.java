...
import com.itfitness.statelayout.R;
...
public class StateLayout extends RelativeLayout {
    ...
    public StateLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mEmptyViewResId =
                a.getResourceId(R.styleable.StateLayout_emptyView, R.layout.custom_empty_view);
        mErrorViewResId =
                a.getResourceId(R.styleable.StateLayout_errorView, R.layout.custom_error_view);
        mLoadingViewResId =
                a.getResourceId(R.styleable.StateLayout_loadingView, R.layout.custom_loading_view);
        mNoNetworkViewResId = a.getResourceId(R.styleable.StateLayout_noNetworkView,
                R.layout.custom_no_network_view);
        mContentViewResId = a.getResourceId(R.styleable.StateLayout_contentView,
                NULL_RESOURCE_ID);
        a.recycle();
    }
